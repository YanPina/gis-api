...
class MakeValidGeometries:
        ...
        def __init__(self, geodataframe:gpd.GeoDataFrame) -> None:
                self.geon_type_list:list = ['Polygon', 'MultiPolygon', 'GeometryCollection', 'Point']
...
class Buffer:
        def __init__(self, geodataframe:gpd.GeoDataFrame, area_buffer:float) -> None:
                self.area_buffer = area_buffer
                self.geodataframe = geodataframe

        
        def _buffer_area(self) -> gpd.GeoDataFrame:
                self.geodataframe['geometry'] = self.geodataframe.geometry.buffer(self.area_buffer)
